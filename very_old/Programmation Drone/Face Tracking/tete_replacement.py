...
imgMustache = cv2.imread('small.png',-1)
    ...
    for (x, y, w, h) in faces:
        ...
        for (nx,ny,nw,nh) in nose:
            try:
                ...
                x1 = int(x - mustacheWidth) #int(x - (mustacheWidth/2))
                x2 = int(x + w + mustacheWidth) #int(x + w + (mustacheWidth/2))
                y1 = int(y - mustacheHeight) #int(y + h - (mustacheHeight/1))
                y2 = int(y + h + mustacheHeight) #int(y + h + (mustacheHeight/1))
